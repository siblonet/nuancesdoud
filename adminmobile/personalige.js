const pErsonnalige = () => {
    (async function ($) {
        ...
        if (annoncePers && annoncePers.length > 0) {
            $("#slidea").css("background-image", `url(${annoncePers.find(item => item.which === "slidea") ? annoncePers.find(item => item.which === "slidea").image : "../assets/img/par1.png"})`);
            $("#slideb").css("background-image", `url(${annoncePers.find(item => item.which === "slideb") ? annoncePers.find(item => item.which === "slideb").image : "../assets/img/par1.png"})`);
            $("#slidec").css("background-image", `url(${annoncePers.find(item => item.which === "slidec") ? annoncePers.find(item => item.which === "slidec").image : "../assets/img/par1.png"})`);
            ...
            $("#phonea").css("background-image", `url(${annoncePers.find(item => item.which === "phonea") ? annoncePers.find(item => item.which === "phonea").image : "../assets/img/par1.png"})`);
            $("#phoneb").css("background-image", `url(${annoncePers.find(item => item.which === "phoneb") ? annoncePers.find(item => item.which === "phoneb").image : "../assets/img/par1.png"})`);
            $("#phonec").css("background-image", `url(${annoncePers.find(item => item.which === "phonec") ? annoncePers.find(item => item.which === "phonec").image : "../assets/img/par1.png"})`);
            ...
            $("#backglise").css("background-image", `url(${annoncePers.find(item => item.which === "backglise") ? annoncePers.find(item => item.which === "backglise").image : "../assets/img/par1.png"})`);
            ...
            $("#loginimg").css("background-image", `url(${annoncePers.find(item => item.which === "loginimg") ? annoncePers.find(item => item.which === "loginimg").image : "../assets/img/par1.png"})`);
            ...
            $("#slidea").css("background-image", "url(../assets/img/par1.png)");
            $("#slideb").css("background-image", "url(../assets/img/par1.png)");
            $("#slidec").css("background-image", "url(../assets/img/par1.png)");

            $("#phonea").css("background-image", "url(../assets/img/par1.png)");
            $("#phoneb").css("background-image", "url(../assets/img/par1.png)");
            $("#phonec").css("background-image", "url(../assets/img/par1.png)");

            $("#backglise").css("background-image", 'url(../assets/img/par1.png)');
